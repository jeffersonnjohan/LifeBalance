...
<nav class="justify-evenly fixed bg-gradient-to-b from-cLightGrey from-30% to-transparent w-full z-10">
    <div class="max-w-screen-xl px-4 py-3 mx-auto lg:mx-4">
        <div class="flex items-center">
            ...
            {{-- <a href="/profile""
                class="fixed bg-cGreen rounded-b-3xl flex justify-center items-center aspect-square h-[50px] shadow-lg right-2 -top-0.5 z-10 group duration-300 ease-out hover:bg-white">
...
@section('body')
    <form action="/admin/diet" method="post"
        ...
        <div class="lg:relative">
            <div
                class="lg:fixed lg:bg-cGreen lg:flex lg:flex-col lg:place-content-center lg:m-auto lg:h-full lg:rounded-r-[100px] lg:w-[25%]">
                ...
                <div class="flex flex-row lg:flex-col gap-2 pt-2 pb-2 px-3 ">
                    <div
                        class="ring-cGreen hover:ring-cGreen w-[75%] lg:w-full h-[50px] rounded-full bg-white flex items-center text-cDarkGrey px-4 duration-300 hover:ring-2  focus-within:text-cGreen focus-within:ring-2 hover:text-cGreen shadow-lg">
                    ...
                    @error('planTitle')
                        <p class="text-cLightGrey text text-left -mt-2 px-2 text-xs">{{ $message }}</p>
                    @enderror
                    <div
                        class="ring-cGreen hover:ring-cGreen w-[25%] lg:w-full h-[50px] rounded-full bg-white flex items-center text-cDarkGrey px-4 duration-300 hover:ring-2 focus-within:text-cGreen focus-within:ring-2 hover:text-cGreen shadow-lg">
                ...
                <div class="flex flex-row lg:flex-col lg:pt-0 gap-2 pt-2 pb-2 px-3 ">
                    <div
                        class="ring-cGreen hover:ring-cGreen w-[75%] lg:w-full h-[120px] rounded-3xl bg-white flex items-center text-cDarkGrey px-4 duration-300 hover:ring-2 focus-within:text-cGreen focus-within:ring-2 hover:text-cGreen shadow-lg">
                        {{-- <input type="text" name="description" id="description" placeholder="Description" required class="p-0 text-left lg:text-center border-transparent bg-transparent focus:ring-0 focus:border-transparent text-sm w-full "> --}}
                    ...
                    <div class="w-[25%] h-[120px] flex items-center text-cDarkGrey justify-between pl-0 lg:w-full">
                        <div class="relative w-full aspect-square h-full bg-white rounded-3xl shadow-lg">
                            ...
                            <label for="image"
                                class="h-full w-full ring-cGreen hover:ring-cGreen aspect-square rounded-3xl p-2 flex flex-col justify-center items-center cursor-pointer duration-300 hover:ring-2 focus-within:ring-2 hover:text-cGreen bg-cover bg-center absolute"
                                id="imgBox">
                            </label>
        ...
        <div class="lg:flex lg:flex-col lg:w-[75%] lg:ml-[25%]">
            ...
            <div id="containerDay">
                ...
                <div class="px-3">
                    <div class="pt-2 pb-2">
                        <div
                            class="w-full h-[50px] rounded-full bg-cGreen bg-opacity-50 flex items-center text-cDarkGrey px-4">
                            <h2
                                class="dayHeader border-transparent bg-transparent text-sm font-bold text-cDarkBlue text-center w-full">
                                Day 1</h2>
                            <span
                                class="deleteDay material-symbols-outlined rounded-full p-2 scale-100 duration-300 ease-out bg-cRed hover:bg-white hover:text-black text-white cursor-pointer">
                                delete
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-row w-full h-[200px] bg-black bg-opacity-10 pt-2 rounded-3xl">
                        <div class="flex p-2 w-[75%] h-[90%]">
                            <div
                                class="place-content-center h-full w-full rounded-3xl bg-white flex items-center text-cDarkGrey duration-300 ring-cGreen hover:ring-cGreen hover:ring-2 focus-within:text-cGreen focus-within:ring-2 hover:text-cGreen">
                                <textarea type="text" name="dietDayDescription[]" id="description"
                                    placeholder="Description
(e.g.,
Breakfast : 500 gr
Apel Lunch  : Nasi Padang
Dinner : Es buah)" required
                                    class="h-[120px] resize-none border-transparent bg-transparent focus:ring-0 focus:border-transparent text-sm w-full "></textarea>
                            </div>
                        </div>
                        <div class="w-[25%] h-full p-2">
                            <div
                                class="w-full h-[50px] rounded-full bg-white flex items-center text-cDarkGrey px-4 duration-300 ring-cGreen hover:ring-cGreen hover:ring-2 focus-within:text-cGreen focus-within:ring-2 hover:text-cGreen shadow-lg">
            ...
            <div class="bottom-0 fixed lg:relative pb-4 lg:pb-0 w-full px-3">
                <div class="lg:fixed lg:right-0 lg:left-[25%] lg:px-4 lg:pb-2 lg:flex-row lg:flex lg:gap-2 lg:bottom-0">
                    <div class="pt-2 pb-2 lg:w-[50%]">
                        <div
                            class="w-full h-[50px] rounded-full bg-cGreen text-white flex items-center font-bold px-4 duration-300 hover:ring-2 ring-cGreen focus-within:text-white focus-within:ring-2 hover:text-cGreen hover:bg-white shadow-lg">
                    ...
                    <div class="pt-2 pb-2 bottom-0 lg:w-[50%]">
                        <a href="/admin/diet"
                            ...
                            <div
                                class="border-transparent bg-transparent focus:ring-0 focus:border-transparent text-sm w-full text-center cursor-pointer">
                                Discard</div>
                        </a>
                    </div>
                </div>
