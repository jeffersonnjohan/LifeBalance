...
@section('body')
        ...
        <div class="pt-16 bg-white w-full">
            <div class="flex flex-row gap-2 pt-2 pb-2 px-3">
                <div class="w-[75%] h-[50px] rounded-full bg-cLightGrey flex items-center text-cDarkGrey px-4 duration-300 hover:ring-2 focus-within:text-cGreen focus-within:ring-2 hover:text-cGreen shadow-lg">
                ...
                <div class="w-[25%] h-[50px] rounded-full bg-cLightGrey flex items-center text-cDarkGrey px-4 duration-300 hover:ring-2 focus-within:text-cGreen focus-within:ring-2 hover:text-cGreen shadow-lg">
            ...
            <div class="flex flex-row gap-2 pt-2 pb-2 px-3">
                <div class="w-[75%] h-[120px] rounded-3xl bg-cLightGrey flex items-center text-cDarkGrey px-4 duration-300 hover:ring-2 focus-within:text-cGreen focus-within:ring-2 hover:text-cGreen shadow-lg">
            ...
            <div class="px-3">
                ...
                <div class="flex flex-row w-full h-[200px] bg-black bg-opacity-10 pt-2 rounded-3xl">
                    <div class="flex p-2 w-[75%] h-[90%]">
                        <div class="place-content-center h-full w-full rounded-3xl bg-cLightGrey flex items-center text-cDarkGrey duration-300 hover:ring-2 focus-within:text-cGreen focus-within:ring-2 hover:text-cGreen">
...
Dinner : Es buah)" required class="h-full border-transparent bg-transparent focus:ring-0 focus:border-transparent text-sm w-full "></textarea>
                    ...
                    <div class="w-[25%] h-full p-2">
                        <div class="w-full h-[50px] rounded-full bg-cLightGrey flex items-center text-cDarkGrey px-4 duration-300 hover:ring-2 focus-within:text-cGreen focus-within:ring-2 hover:text-cGreen shadow-lg">
