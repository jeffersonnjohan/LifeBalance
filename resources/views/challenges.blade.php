...
@section('body')
    <div class="bg-cLightGrey h-full w-full mb-28">
        <div class="bg-cOrange h-fit rounded-b-[50px] mb-2">
            <h1 class="text-white text-3xl font-normal text-left pt-12 pb-12 pl-10 pr-10">Ayo Ikuti Challenge
                <br> Dan Dapatkan Keuntungan Pointnya!</h1>
        </div>
        <div class="p-2">
            <div class="bg-white rounded-3xl h-fit shadow-lg">
                <div class="relative">
                ...
                <div class="p-2">
                    <h3 class="font-semibold pl-2 pr-2 mr-20 pt-4 text-lg">Finish First Workout</h3>
