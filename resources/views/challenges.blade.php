                ...
                <div class="p-2 lg:w-1/3 lg:h-fit">
                    <div class="bg-white rounded-3xl h-fit shadow-lg group duration-300 ease-out hover:bg-orange-100 focus:ring-cOrange flex flex-col">
                        ...
                        <div class="p-2 flex flex-col pt-7 gap-2">
                            ...
                            @if($arrworkout[$i] >= $challengeData[$i]['workout_plan_count'] and $arrdiet[$i] >= $challengeData[$i]['diet_plan_count'])
                                <a href="/challenges/claim/{{ $challengeData[$i]['id'] }}" class="w-full h-fit py-2 px-5 rounded-full bg-cOrange text-white border-2 hover:bg-white hover:border-cOrange hover:text-cOrange duration-300 ease-out cursor-pointer text-center">
                                    Claim
                                </a>
                            @endif
                        </div>
