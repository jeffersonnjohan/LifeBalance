    ...
    <div class="fixed h-full w-full flex p-3">
        ...
        <div class="bg-white w-fit h-fit m-auto absolute left-[50%] translate-x-[-50%] top-[50%] translate-y-[-50%] rounded-3xl flex flex-col justify-center items-center text-center p-5 shadow-lg">
            ...
            <form action="/login" class="flex flex-col gap-2" method="post">
                ...
                <input type="submit" value="Log In" class="w-[300px] h-[50px] rounded-full bg-cBlue text-white hover:bg-white hover:text-cBlue border-2 border-cBlue duration-300 ease-out cursor-pointer text-sm font-medium">
                ...
                <a href="/auth/github/redirect" class="w-[300px] h-[50px] rounded-full text-white hover:text-black bg-black hover:bg-white focus:ring-4 focus:outline-none focus:ring-black hover:ring-black font-medium text-sm text-center border-2 border-black inline-flex items-center justify-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 mb-2 duration-300 ease-out cursor-pointer">
